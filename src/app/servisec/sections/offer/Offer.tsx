...
const description = [
  "  Our team is highly skilled with full-stack development of any web-related software, whether it is static, dynamic, portal web apps, orContent Management Systems (CMS)",
  "    We design and create stunning applicatio for anyone, from startups to large corporations, with such up-to-date features and qualities:",
];
